...
app.post("/districts/", authenticateToken, async (request, response)=>{
    ...
    INSERT INTO 
        district (state_id, district_name, cases, curved, active, deaths)
    VALUES 
       (${stateId}, '${districtName}', ${cases}, ${curved}, ${active}, ${deaths};`;
...
app.put(
    "/district/:districtId/", authenticateToken, async (request, response)=>{
        const {districtId} = request.params;
        const {
            districtName,
            stateId,
